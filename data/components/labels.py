...
class Textbox(pg.sprite.Sprite, tools._KwargMixin):
    """
    Allows the user to type and enter text.  which
    accepts a number of keyword arguments to allow customization
    of a textbox's appearance and behavior. Textboxes
    """
    _invisible = pg.Surface((1,1)).convert_alpha()
    _invisible.fill((0,0,0,0))
